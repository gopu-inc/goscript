...
// Fonction try-catch simulée avec un dictionnaire de retour
pub fn try_catch(fn_to_try: lambda, catch_handler: lambda) -> any {
    muts result = nil
    muts error_occurred = false
    
    // Essayer d'exécuter la fonction
    muts try_result = fn_to_try()
    result = try_result
    ret result
}
